...
.method public static getInstance(Landroid/content/Context;)Lcom/google/android/gms/tagmanager/TagManager;
    ...
    :try_start_0
    sget-object v1, Lcom/google/android/gms/tagmanager/TagManager;->zzaAS:Lcom/google/android/gms/tagmanager/TagManager;
    ...
    invoke-direct {v3, p0, v1, v4, v2}, Lcom/google/android/gms/tagmanager/TagManager;-><init>(Landroid/content/Context;Lcom/google/android/gms/tagmanager/TagManager$zza;Lcom/google/android/gms/tagmanager/DataLayer;Lcom/google/android/gms/tagmanager/zzcs;)V
...
.method private zzdk(Ljava/lang/String;)V
    ...
    check-cast v1, Lcom/google/android/gms/tagmanager/zzn;

    invoke-virtual {v1, p1}, Lcom/google/android/gms/tagmanager/zzn;->zzcO(Ljava/lang/String;)V
...
.method public zzc(Ljava/lang/String;ILjava/lang/String;)Lcom/google/android/gms/common/api/PendingResult;
    ...
    invoke-virtual {p1, p3}, Lcom/google/android/gms/tagmanager/zzo;->load(Ljava/lang/String;)V
...
.method declared-synchronized zzl(Landroid/net/Uri;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/gms/tagmanager/zzca;->zzl(Landroid/net/Uri;)Z
    ...
    sget-object v1, Lcom/google/android/gms/tagmanager/TagManager$4;->zzaAU:[I

    invoke-virtual {v0}, Lcom/google/android/gms/tagmanager/zzca;->zzty()Lcom/google/android/gms/tagmanager/zzca$zza;

    move-result-object v2

    invoke-virtual {v2}, Lcom/google/android/gms/tagmanager/zzca$zza;->ordinal()I
    ...
    :pswitch_0
    iget-object v1, p0, Lcom/google/android/gms/tagmanager/TagManager;->zzaAR:Ljava/util/concurrent/ConcurrentMap;
    ...
    check-cast v3, Lcom/google/android/gms/tagmanager/zzn;

    invoke-virtual {v3}, Lcom/google/android/gms/tagmanager/zzn;->getContainerId()Ljava/lang/String;
    ...
    invoke-virtual {v3, v4}, Lcom/google/android/gms/tagmanager/zzn;->zzcQ(Ljava/lang/String;)V

    :goto_1
    invoke-virtual {v3}, Lcom/google/android/gms/tagmanager/zzn;->refresh()V

    goto :goto_0

    :cond_1
    invoke-virtual {v3}, Lcom/google/android/gms/tagmanager/zzn;->zzsK()Ljava/lang/String;

    move-result-object v4

    if-eqz v4, :cond_0

    invoke-virtual {v3, v2}, Lcom/google/android/gms/tagmanager/zzn;->zzcQ(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/tagmanager/zzn;->getContainerId()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/gms/tagmanager/zzn;->zzcQ(Ljava/lang/String;)V

    invoke-virtual {v1}, Lcom/google/android/gms/tagmanager/zzn;->refresh()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
