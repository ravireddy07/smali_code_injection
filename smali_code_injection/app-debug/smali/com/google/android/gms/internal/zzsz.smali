...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/gms/tagmanager/Container;Lcom/google/android/gms/internal/zzta;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/internal/zzsz;->zzmB:Lcom/google/android/gms/internal/zzta;
...
.method static zza(Lcom/google/android/gms/tagmanager/Container;Lcom/google/android/gms/internal/zzta;)Lcom/google/android/gms/internal/zzta;
    ...
    invoke-direct {v0, p1}, Lcom/google/android/gms/internal/zzta$zza;-><init>(Ljava/lang/String;)V

    const-string p1, "trackingId"

    invoke-virtual {p0, p1}, Lcom/google/android/gms/tagmanager/Container;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/google/android/gms/internal/zzta$zza;->zzcA(Ljava/lang/String;)Lcom/google/android/gms/internal/zzta$zza;

    move-result-object p1

    const-string v1, "trackScreenViews"

    invoke-virtual {p0, v1}, Lcom/google/android/gms/tagmanager/Container;->getBoolean(Ljava/lang/String;)Z

    move-result v1

    invoke-virtual {p1, v1}, Lcom/google/android/gms/internal/zzta$zza;->zzab(Z)Lcom/google/android/gms/internal/zzta$zza;

    move-result-object p1

    const-string v1, "collectAdIdentifiers"

    invoke-virtual {p0, v1}, Lcom/google/android/gms/tagmanager/Container;->getBoolean(Ljava/lang/String;)Z

    move-result p0

    invoke-virtual {p1, p0}, Lcom/google/android/gms/internal/zzta$zza;->zzac(Z)Lcom/google/android/gms/internal/zzta$zza;
