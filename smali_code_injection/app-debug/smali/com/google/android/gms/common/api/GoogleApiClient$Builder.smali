...
.method private zzhZ()Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/gms/common/api/zzh;->zzar(I)Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    iget-object v4, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMc:Landroid/os/Looper;
    ...
    iget-object v6, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMo:Lcom/google/android/gms/common/api/Api$zzb;

    iget-object v7, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMj:Ljava/util/Map;

    iget-object v8, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMk:Ljava/util/Map;

    iget-object v9, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMp:Ljava/util/Set;

    iget-object v10, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMq:Ljava/util/Set;

    iget v11, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMm:I

    move-object v2, v1

    invoke-direct/range {v2 .. v11}, Lcom/google/android/gms/common/api/zzd;-><init>(Landroid/content/Context;Landroid/os/Looper;Lcom/google/android/gms/common/internal/zzf;Lcom/google/android/gms/common/api/Api$zzb;Ljava/util/Map;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;I)V

    :cond_0
    iget v2, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMm:I

    iget-object v3, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMn:Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;

    invoke-virtual {v0, v2, v1, v3}, Lcom/google/android/gms/common/api/zzh;->zza(ILcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)V
...
.method public addApi(Lcom/google/android/gms/common/api/Api;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    iget-object v3, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMe:Ljava/util/Set;
    ...
    invoke-virtual {v4}, Lcom/google/android/gms/common/api/Scope;->zzio()Ljava/lang/String;
...
.method public build()Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    iget-object v3, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMc:Landroid/os/Looper;

    invoke-virtual {p0}, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzhY()Lcom/google/android/gms/common/internal/zzf;

    move-result-object v4

    iget-object v5, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMo:Lcom/google/android/gms/common/api/Api$zzb;

    iget-object v6, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMj:Ljava/util/Map;

    iget-object v7, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMk:Ljava/util/Map;

    iget-object v8, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMp:Ljava/util/Set;

    iget-object v9, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzMq:Ljava/util/Set;

    const/4 v10, -0x1

    move-object v1, v0

    invoke-direct/range {v1 .. v10}, Lcom/google/android/gms/common/api/zzd;-><init>(Landroid/content/Context;Landroid/os/Looper;Lcom/google/android/gms/common/internal/zzf;Lcom/google/android/gms/common/api/Api$zzb;Ljava/util/Map;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;I)V
...
.method public zzhY()Lcom/google/android/gms/common/internal/zzf;
    .locals 9

    new-instance v8, Lcom/google/android/gms/common/internal/zzf;
