...
.method private setItem(Landroid/view/MenuItem;)V
    ...
    invoke-direct {v0, v1, v3}, Landroid/support/v7/internal/view/SupportMenuInflater$InflatedOnMenuItemClickListener;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 448
    .local v0, "impl":Landroid/support/v7/internal/view/menu/MenuItemImpl;
    :goto_1
    iget v1, p0, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->itemCheckable:I
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/internal/view/menu/MenuItemImpl;->setExclusiveCheckable(Z)V
    ...
    check-cast v1, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;

    invoke-virtual {v1, v2}, Landroid/support/v7/internal/view/menu/MenuItemWrapperICS;->setExclusiveCheckable(Z)V
...
.method public readItem(Landroid/util/AttributeSet;)V
    ...
    iput v1, p0, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->itemId:I

    .line 370
    sget v1, Landroid/support/v7/appcompat/R$styleable;->MenuItem_android_menuCategory:I

    iget v3, p0, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->groupCategory:I
    ...
    iget v4, p0, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->groupOrder:I
    ...
    iget v5, p0, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->itemActionViewLayout:I

    if-nez v5, :cond_2

    iget-object v5, p0, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->itemActionViewClassName:Ljava/lang/String;

    if-nez v5, :cond_2

    .line 400
    iget-object v5, p0, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->itemActionProviderClassName:Ljava/lang/String;
    ...
    invoke-direct {p0, v5, v6, v7}, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->newInstance(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Landroid/support/v4/view/ActionProvider;

    iput-object v5, p0, Landroid/support/v7/internal/view/SupportMenuInflater$MenuState;->itemActionProvider:Landroid/support/v4/view/ActionProvider;
