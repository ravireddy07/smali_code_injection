...
.method private getStateWithUpdatedPosition()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 1351
    :try_start_0
    iget-object v5, v1, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mState:Landroid/support/v4/media/session/PlaybackStateCompat;
    :try_end_0
    ...
    :try_start_1
    iget-object v6, v1, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mMetadata:Landroid/support/v4/media/MediaMetadataCompat;
    ...
    invoke-virtual {v6, v7}, Landroid/support/v4/media/MediaMetadataCompat;->containsKey(Ljava/lang/String;)Z
    ...
    invoke-virtual {v6, v7}, Landroid/support/v4/media/MediaMetadataCompat;->getLong(Ljava/lang/String;)J
    ...
    .line 1375
    .local v13, "builder":Landroid/support/v4/media/session/PlaybackStateCompat$Builder;
    invoke-virtual {v5}, Landroid/support/v4/media/session/PlaybackStateCompat;->getState()I
    ...
    .line 1375
    .end local v13    # "builder":Landroid/support/v4/media/session/PlaybackStateCompat$Builder;
    ...
    .end local v17    # "position":J
    .local v1, "result":Landroid/support/v4/media/session/PlaybackStateCompat;
    goto :goto_2

    .line 1381
    .end local v1    # "result":Landroid/support/v4/media/session/PlaybackStateCompat;
    .restart local v4    # "result":Landroid/support/v4/media/session/PlaybackStateCompat;
    :cond_4
    move-object v1, v4

    .line 1381
    .end local v4    # "result":Landroid/support/v4/media/session/PlaybackStateCompat;
    .restart local v1    # "result":Landroid/support/v4/media/session/PlaybackStateCompat;
    :goto_2
    if-nez v1, :cond_5
...
.method public setMetadata(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    :goto_1
    invoke-static {v1, v2, v0}, Landroid/support/v4/media/session/MediaSessionCompatApi19;->setMetadata(Ljava/lang/Object;Landroid/os/Bundle;Z)V
