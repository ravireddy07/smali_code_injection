...
.method public static fromPlaybackState(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-direct/range {v2 .. v13}, Landroid/support/v4/media/session/PlaybackStateCompat;-><init>(IJJFJLjava/lang/CharSequence;J)V
...
.method public getPlaybackState()Ljava/lang/Object;
    ...
    iget-wide v5, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mBufferedPosition:J

    iget v7, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mSpeed:F

    iget-wide v8, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mActions:J

    iget-object v10, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mErrorMessage:Ljava/lang/CharSequence;

    iget-wide v11, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mUpdateTime:J
