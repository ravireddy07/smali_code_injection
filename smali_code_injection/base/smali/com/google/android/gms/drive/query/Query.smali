...
.field private final zzWP:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set",
            "<",
...
.field final zzaaC:Lcom/google/android/gms/drive/query/internal/LogicalFilter;

.field final zzaaD:Ljava/lang/String;

.field final zzaaE:Lcom/google/android/gms/drive/query/SortOrder;
...
.method private constructor <init>(ILcom/google/android/gms/drive/query/internal/LogicalFilter;Ljava/lang/String;Lcom/google/android/gms/drive/query/SortOrder;Ljava/util/List;ZLjava/util/List;Ljava/util/Set;)V
    ...
    iput p1, p0, Lcom/google/android/gms/drive/query/Query;->zzzH:I

    iput-object p2, p0, Lcom/google/android/gms/drive/query/Query;->zzaaC:Lcom/google/android/gms/drive/query/internal/LogicalFilter;

    iput-object p3, p0, Lcom/google/android/gms/drive/query/Query;->zzaaD:Ljava/lang/String;

    iput-object p4, p0, Lcom/google/android/gms/drive/query/Query;->zzaaE:Lcom/google/android/gms/drive/query/SortOrder;

    iput-object p5, p0, Lcom/google/android/gms/drive/query/Query;->zzaaF:Ljava/util/List;

    iput-boolean p6, p0, Lcom/google/android/gms/drive/query/Query;->zzaaG:Z

    iput-object p7, p0, Lcom/google/android/gms/drive/query/Query;->zzWO:Ljava/util/List;

    iput-object p8, p0, Lcom/google/android/gms/drive/query/Query;->zzWP:Ljava/util/Set;
...
.method public getFilter()Lcom/google/android/gms/drive/query/Filter;
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/query/Query;->zzaaC:Lcom/google/android/gms/drive/query/internal/LogicalFilter;
...
.method public getPageToken()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/query/Query;->zzaaD:Ljava/lang/String;
...
.method public getSortOrder()Lcom/google/android/gms/drive/query/SortOrder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/query/Query;->zzaaE:Lcom/google/android/gms/drive/query/SortOrder;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/google/android/gms/drive/query/Query;->zzaaC:Lcom/google/android/gms/drive/query/internal/LogicalFilter;

    aput-object v4, v2, v3

    const/4 v3, 0x1

    iget-object v4, p0, Lcom/google/android/gms/drive/query/Query;->zzaaE:Lcom/google/android/gms/drive/query/SortOrder;

    aput-object v4, v2, v3

    const/4 v3, 0x2

    iget-object v4, p0, Lcom/google/android/gms/drive/query/Query;->zzaaD:Ljava/lang/String;

    aput-object v4, v2, v3

    const/4 v3, 0x3

    iget-object v4, p0, Lcom/google/android/gms/drive/query/Query;->zzWO:Ljava/util/List;
...
.method public zzom()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/query/Query;->zzaaF:Ljava/util/List;
...
.method public zzon()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/drive/query/Query;->zzaaG:Z

    return v0
.end method

.method public zzoo()Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/google/android/gms/drive/query/Query;->zzWP:Ljava/util/Set;
