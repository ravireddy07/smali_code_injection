...
# instance fields
.field final zzarB:Ljava/util/List;
...
.field final zzarH:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field final zzarI:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private final zzarK:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/location/places/PlaceFilter;->CREATOR:Lcom/google/android/gms/location/places/zzd;
...
.method constructor <init>(ILjava/util/List;ZLjava/util/List;Ljava/util/List;)V
    ...
    iput p1, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzzH:I
    ...
    :goto_0
    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarB:Ljava/util/List;

    iput-boolean p3, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarG:Z
    ...
    :goto_1
    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarH:Ljava/util/List;
    ...
    :goto_2
    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarI:Ljava/util/List;

    iget-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarB:Ljava/util/List;

    invoke-static {v0}, Lcom/google/android/gms/location/places/PlaceFilter;->zzm(Ljava/util/List;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarC:Ljava/util/Set;

    iget-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarH:Ljava/util/List;

    invoke-static {v0}, Lcom/google/android/gms/location/places/PlaceFilter;->zzm(Ljava/util/List;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarJ:Ljava/util/Set;

    iget-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarI:Ljava/util/List;

    invoke-static {v0}, Lcom/google/android/gms/location/places/PlaceFilter;->zzm(Ljava/util/List;)Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarK:Ljava/util/Set;
...
.method public constructor <init>(Ljava/util/Collection;ZLjava/util/Collection;Ljava/util/Collection;)V
    ...
    invoke-static {p4}, Lcom/google/android/gms/location/places/PlaceFilter;->zzb(Ljava/util/Collection;)Ljava/util/List;
...
.method private static zzb(Ljava/util/Collection;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method private static zzm(Ljava/util/List;)Ljava/util/Set;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public static zzsU()Lcom/google/android/gms/location/places/PlaceFilter;
    .locals 2
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/location/places/PlaceFilter$zza;->zzsV()Lcom/google/android/gms/location/places/PlaceFilter;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .end local p1    # "object":Ljava/lang/Object;
    iget-object v2, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarC:Ljava/util/Set;

    iget-object v3, p1, Lcom/google/android/gms/location/places/PlaceFilter;->zzarC:Ljava/util/Set;
    ...
    iget-boolean v2, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarG:Z

    iget-boolean v3, p1, Lcom/google/android/gms/location/places/PlaceFilter;->zzarG:Z

    if-ne v2, v3, :cond_3

    iget-object v2, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarJ:Ljava/util/Set;

    iget-object v3, p1, Lcom/google/android/gms/location/places/PlaceFilter;->zzarJ:Ljava/util/Set;
    ...
    iget-object v2, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarK:Ljava/util/Set;

    iget-object v3, p1, Lcom/google/android/gms/location/places/PlaceFilter;->zzarK:Ljava/util/Set;
...
.method public getPlaceIds()Ljava/util/Set;
    ...
    iget-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarK:Ljava/util/Set;
...
.method public getPlaceTypes()Ljava/util/Set;
    ...
    iget-object v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarC:Ljava/util/Set;
...
.method public isRestrictedToPlacesOpenNow()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarG:Z
...
.method public matches(Lcom/google/android/gms/location/places/Place;)Z
    ...
    invoke-interface {p1}, Lcom/google/android/gms/location/places/Place;->zzsT()Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarC:Ljava/util/Set;
    ...
    iget-object v1, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarK:Ljava/util/Set;
    ...
    :cond_1
    iget-object v1, p0, Lcom/google/android/gms/location/places/PlaceFilter;->zzarJ:Ljava/util/Set;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-static {p0, p1, p2}, Lcom/google/android/gms/location/places/zzd;->zza(Lcom/google/android/gms/location/places/PlaceFilter;Landroid/os/Parcel;I)V
